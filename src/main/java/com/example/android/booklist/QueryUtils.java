        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                if(pdf.has("acsTokenLink"))
                    down=pdf.getString("acsTokenLink");
                if(volume.has("authors")) {
                    JSONArray authors = volume.getJSONArray("authors");

                    author = authors.getString(0);
                }
                JSONArray industry=volume.getJSONArray("industryIdentifiers");
                String url="";
                String isbn="";
                JSONObject ob=industry.getJSONObject(0);
                isbn=ob.getString("identifier");
                JSONObject read=volume.getJSONObject("readingModes");
                Boolean text=read.getBoolean("text");
                Boolean img=read.getBoolean("image");
                ...
                Book book = new Book(title, url,link,author,down,isbn,text,img);
